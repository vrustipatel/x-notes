package e.wolfsoft1.Xnotes.fragments;
...
public class PlaybackFragment extends DialogFragment {
    ...
    public PlaybackFragment newInstance(NotePostModel item) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        minutes = item.getTimeLengthMinutes();
        seconds = item.getTimeLengthSeconds();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        ColorFilter filter = new LightingColorFilter
                (getResources().getColor(R.color.colorPrimary), getResources().getColor(R.color.black));
