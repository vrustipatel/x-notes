...
public class ImagePost extends AppCompatActivity {
    ...
    ImageView mImageView, back, trashIcon;
    private String key, title, content, image, labelKey, newkey, tag, strDate;
    private Dialog slideDialog;
    LinearLayout linearLayoutBgColor, deletePost;
    TextView labelName, postEditedTime, titleToolbar, addingNotesInLabel;
